document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- DATOS SIMULADOS PARA GRÁFICOS DE EVOLUCIÓN NACIONAL (HOMICIDIO, SECUESTRO, EXTORSIÓN) ---
    const labels = [
    ...
    // --- CONFIGURACIÓN BASE PARA LAS GRÁFICAS ---
    const chartConfig = {
        responsive: true,
        plugins: {
    ...
    // Solo inicializa las gráficas si los elementos Canvas existen (están en index.html)
